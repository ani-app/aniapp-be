...
router.get('/', async function(req, res) {
    try {
        let breedTypes = await breedTypeService.GetAllBreeds();
...
router.get('/:id', async function(req, res) {
    try {
        let breedType = await breedTypeService.GetBreed(req.params.id);
...
router.post('/', async function(req, res) {
    try {
        let breedType = await breedTypeService.CreateBreed(req.body);
...
router.put('/:id', async function(req, res) {
    try {
        ...
        let breedType = await breedTypeService.UpdateBreed(req.body);
...
router.delete('/', async function(req, res) {
    try {
        await breedTypeService.DeleteBreed(req.params.id);
